...
#if defined(NDEBUG)
# error "Thinkcoin cannot be compiled without assertions."
#endif
...
uint256 hashGenesisBlock("0xd2f4f81934e6e1ae128a3e52b053e6bb6177b18b07827344837c2680e1e782f8");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Thinkcoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Thinkcoin Signed Message:\n";
...
{
    // Thinkcoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Thinkcoin: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Thinkcoin: Special short-term limits to avoid 10,000 BDB lock limit:
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xd2f4f81934e6e1ae128a3e52b053e6bb6177b18b07827344837c2680e1e782f8");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // CBlock(hash=12a765e31ffd4059bada, PoW=0000050c34a64b415b6b, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=97ddfbbae6, nTime=1440097208, nBits=1e0ffff0, nNonce=0, vtx=1)
        ...
        // Genesis block
        const char* pszTimestamp = "20/Aug/2015 BBC News 20 Aug 2015 Fire ravages Normanton school building";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1440097208;
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 1320850;
        ...
        assert(block.hashMerkleRoot == uint256("0x5031ac28a7a0a146f7b1e938c7d07a26ede9073650c09851bcb613835f4f10b2"));
...
unsigned char pchMessageStart[4] = { 0xc3, 0xd2, 0xd1, 0xbd }; // Thinkcoin: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("ThinkcoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("ThinkcoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static ThinkcoinMiner(CWallet *pwallet)
{
    printf("ThinkcoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("thinkcoin-miner");
    ...
    try { loop {
        ...
        printf("Running ThinkcoinMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
    ...
    {
        printf("ThinkcoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&ThinkcoinMiner, pwallet));
}
